...
Проект создан как тестовое задание перед собеседованием. Представляет собой REST API приложение для справочника Организаций, Зданий и Деятельности с возможностью поиска по различным критериям, включая геолокацию.
